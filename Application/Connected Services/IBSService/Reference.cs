...
namespace IBSService
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="IBSService.IBSServicesSoap")]
    public interface IBSServicesSoap
    {
        ...
        System.Threading.Tasks.Task<IBSService.IBSBridgeResponse> IBSBridgeAsync(IBSService.IBSBridgeRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBSBridgeNE", ReplyAction="*")]
        System.Threading.Tasks.Task<IBSService.IBSBridgeNEResponse> IBSBridgeNEAsync(IBSService.IBSBridgeNERequest request);
    }
    ...
    public partial class IBSBridgeRequest
    {
        ...
        public IBSService.IBSBridgeRequestBody Body;
        
        public IBSBridgeRequest()
        {
        }
        
        public IBSBridgeRequest(IBSService.IBSBridgeRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class IBSBridgeResponse
    {
        ...
        public IBSService.IBSBridgeResponseBody Body;
        
        public IBSBridgeResponse()
        {
        }
        
        public IBSBridgeResponse(IBSService.IBSBridgeResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class IBSBridgeNERequest
    {
        ...
        public IBSService.IBSBridgeNERequestBody Body;
        
        public IBSBridgeNERequest()
        {
        }
        
        public IBSBridgeNERequest(IBSService.IBSBridgeNERequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class IBSBridgeNEResponse
    {
        ...
        public IBSService.IBSBridgeNEResponseBody Body;
        
        public IBSBridgeNEResponse()
        {
        }
        
        public IBSBridgeNEResponse(IBSService.IBSBridgeNEResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface IBSServicesSoapChannel : IBSService.IBSServicesSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class BSServicesSoapClient : System.ServiceModel.ClientBase<IBSService.IBSServicesSoap>, IBSService.IBSServicesSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<IBSService.IBSBridgeResponse> IBSService.IBSServicesSoap.IBSBridgeAsync(IBSService.IBSBridgeRequest request)
        {
            return base.Channel.IBSBridgeAsync(request);
        }
        
        public System.Threading.Tasks.Task<IBSService.IBSBridgeResponse> IBSBridgeAsync(string request, int Appid)
        {
            IBSService.IBSBridgeRequest inValue = new IBSService.IBSBridgeRequest();
            inValue.Body = new IBSService.IBSBridgeRequestBody();
            inValue.Body.request = request;
            inValue.Body.Appid = Appid;
            return ((IBSService.IBSServicesSoap)(this)).IBSBridgeAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<IBSService.IBSBridgeNEResponse> IBSService.IBSServicesSoap.IBSBridgeNEAsync(IBSService.IBSBridgeNERequest request)
        {
            return base.Channel.IBSBridgeNEAsync(request);
        }
        
        public System.Threading.Tasks.Task<IBSService.IBSBridgeNEResponse> IBSBridgeNEAsync(string request, int Appid)
        {
            IBSService.IBSBridgeNERequest inValue = new IBSService.IBSBridgeNERequest();
            inValue.Body = new IBSService.IBSBridgeNERequestBody();
            inValue.Body.request = request;
            inValue.Body.Appid = Appid;
            return ((IBSService.IBSServicesSoap)(this)).IBSBridgeNEAsync(inValue);
        }
