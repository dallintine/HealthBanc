...
namespace ServiceReference1
{
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceReference1.IBSServicesSoap")]
    public interface IBSServicesSoap
    {
        ...
        System.Threading.Tasks.Task<ServiceReference1.IBSBridgeResponse> IBSBridgeAsync(ServiceReference1.IBSBridgeRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IBSBridgeNE", ReplyAction="*")]
        System.Threading.Tasks.Task<ServiceReference1.IBSBridgeNEResponse> IBSBridgeNEAsync(ServiceReference1.IBSBridgeNERequest request);
    }
    ...
    public partial class IBSBridgeRequest
    {
        ...
        public ServiceReference1.IBSBridgeRequestBody Body;
        
        public IBSBridgeRequest()
        {
        }
        
        public IBSBridgeRequest(ServiceReference1.IBSBridgeRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class IBSBridgeResponse
    {
        ...
        public ServiceReference1.IBSBridgeResponseBody Body;
        
        public IBSBridgeResponse()
        {
        }
        
        public IBSBridgeResponse(ServiceReference1.IBSBridgeResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class IBSBridgeNERequest
    {
        ...
        public ServiceReference1.IBSBridgeNERequestBody Body;
        
        public IBSBridgeNERequest()
        {
        }
        
        public IBSBridgeNERequest(ServiceReference1.IBSBridgeNERequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class IBSBridgeNEResponse
    {
        ...
        public ServiceReference1.IBSBridgeNEResponseBody Body;
        
        public IBSBridgeNEResponse()
        {
        }
        
        public IBSBridgeNEResponse(ServiceReference1.IBSBridgeNEResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface IBSServicesSoapChannel : ServiceReference1.IBSServicesSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class BSServicesSoapClient : System.ServiceModel.ClientBase<ServiceReference1.IBSServicesSoap>, ServiceReference1.IBSServicesSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceReference1.IBSBridgeResponse> ServiceReference1.IBSServicesSoap.IBSBridgeAsync(ServiceReference1.IBSBridgeRequest request)
        {
            return base.Channel.IBSBridgeAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.IBSBridgeResponse> IBSBridgeAsync(string request, int Appid)
        {
            ServiceReference1.IBSBridgeRequest inValue = new ServiceReference1.IBSBridgeRequest();
            inValue.Body = new ServiceReference1.IBSBridgeRequestBody();
            inValue.Body.request = request;
            inValue.Body.Appid = Appid;
            return ((ServiceReference1.IBSServicesSoap)(this)).IBSBridgeAsync(inValue);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<ServiceReference1.IBSBridgeNEResponse> ServiceReference1.IBSServicesSoap.IBSBridgeNEAsync(ServiceReference1.IBSBridgeNERequest request)
        {
            return base.Channel.IBSBridgeNEAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference1.IBSBridgeNEResponse> IBSBridgeNEAsync(string request, int Appid)
        {
            ServiceReference1.IBSBridgeNERequest inValue = new ServiceReference1.IBSBridgeNERequest();
            inValue.Body = new ServiceReference1.IBSBridgeNERequestBody();
            inValue.Body.request = request;
            inValue.Body.Appid = Appid;
            return ((ServiceReference1.IBSServicesSoap)(this)).IBSBridgeNEAsync(inValue);
        }
