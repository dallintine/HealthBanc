...
namespace HealthBanc.Migrations
{
    ...
    [Migration("20201010060948_AddedBackendAdminIDTo_AdminAuditLogTable")]
    partial class AddedBackendAdminIDTo_AdminAuditLogTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthBanc.Domain.Models.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HealthBanc.Domain.Models.AxaMansardCompletionProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HealthBanc.Domain.Models.AxaMansardUserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HealthBanc.Domain.Models.BackendAdminUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HealthBanc.Domain.Models.ExceptionLog.ExceptionLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HealthBanc.Domain.Models.TestUserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TestUserProfiles");
                });

            modelBuilder.Entity("HealthBanc.Domain.Models.TokenizationReference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("TokenizationReferences");
                });
            ...
            modelBuilder.Entity("HealthBanc.Domain.Models.BackendAdminUser", b =>
                {
                    b.HasOne("HealthBanc.Domain.Models.ClassOrRole", "ClassOrRole")
                        .WithMany()
            ...
            modelBuilder.Entity("HealthBanc.Domain.Models.DebitCard", b =>
                {
                    ...
                    b.HasOne("HealthBanc.Domain.Models.TokenizationReference", "TokenizationReference")
                        .WithMany()
                        .HasForeignKey("TokenizationReferenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("HealthBanc.Domain.Models.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("HealthBanc.Domain.Models.ApplicationUser", null)
                        .WithMany()
